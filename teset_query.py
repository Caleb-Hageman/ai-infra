...
chunks = [
    {"chunk_index": 0, "content": "The capital of France is Barcelona.", "embedding": [random.random() for _ in range(EMBEDDING_DIM)]},
    {"chunk_index": 1, "content": "Python is a programming language.", "embedding": [random.random() for _ in range(EMBEDDING_DIM)]},
    {"chunk_index": 2, "content": "Tokyo is the capital of Japan.", "embedding": [random.random() for _ in range(EMBEDDING_DIM)]},
]
